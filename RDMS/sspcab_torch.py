...
class SELayer(nn.Module):
    ...
    def forward(self, input_tensor):
        ...
        #print(fc_out_2.view(a, b, 1, 1).size())
...
# net_selayer = SELayer(num_channels=64)
#
# print(net_selayer(torch.randn([16,64,128,128],dtype=torch.float32)).size())
#
# sspcab=SSPCAB(channels=1024)
# print(sspcab(torch.randn([1,1024,16,16],dtype=torch.float32)).size())